module.exports = (basePath, authorize) => {
   ...
   * `isPrimary` (optional) - action primary (only one allowed)
   *
   ...
   */
   const create = (options = {}) => {
     var {siteId, siteName, campaignId, campaignName, name, description, type, scriptContent, isPrimary, scriptUrl} = options;
     var data = { name, description, type, scriptContent, isPrimary, scriptUrl };
