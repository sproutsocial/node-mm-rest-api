module.exports = (basePath, authorize) => {
   ...
   * `campaignName` (optional if `campaignId` provided) - name of the campaign to be fetched
   *
   * `name` - campaign script name
   * `description` - campaign script description
  ...
  const update = (options = {}) => {
    var {siteId, siteName, campaignId, campaignName, scriptId, scriptName, name, description, content} = options;
