...
describe('getTokenURL()', () => {
  it('Returns request URL to get access token', () => {
    const token = auth.getTokenURL('https://api-auth-us.maxymiser.com/oauth2/v1');
    const expectedResult = 'https://api-auth-us.maxymiser.com/oauth2/v1/tokens';
...
describe('getAccessToken()', () => {
  it('Returns Bearer Access Token', () => {
    ...
    const promise = auth.getAccessToken('https://api-auth-us.maxymiser.com/oauth2/v1', credentials);
...
describe('authorize()', () => {
  it('returns a Promise with the authorization token', () => {
    ...
    const authorize = auth.authorize(
      token,
      'https://api-auth-us.maxymiser.com/oauth2/v1',
      {
        clientId: 'clientId',
        clientSecret: 'clientSecret',
        username: 'username',
